package com.bptn.course.day_10.CustomExceptionUsingHashmap;

import java.util.HashMap;
import java.util.Map;

import com.bptn.course.day_10.OutOfStockException;
...
public class Store {
    ...
    public void purchase(String product, int quantity) throws OutOfStockException {
        ...
        if (!products.containsKey(product)) {
            ...
            throw new OutOfStockException("Product " + product + " is not available.");
        }
