...
import java.util.ArrayList;// This is the required import for an ArryaList and/or List

public class ArrayListBasics {
    public static void main(String[] args) {

       // Wrapper Classes
       // ArrayList<int> numbersList = null; /* Declare */
       ArrayList<Integer> numbersList = null; /* Declare */
